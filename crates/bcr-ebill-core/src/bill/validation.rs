...
mod tests {
    use crate::{
        ...
        tests::tests::{
            OTHER_VALID_PAYMENT_ADDRESS_TESTNET, TEST_BILL_ID, TEST_PRIVATE_KEY_SECP,
            VALID_PAYMENT_ADDRESS_TESTNET, node_id_test, node_id_test_other, valid_address,
    ...
    fn valid_bill_validate_action_data(chain: BillBlockchain) -> BillValidateActionData {
        BillValidateActionData {
            ...
            bill_keys: BillKeys {
                ...
                public_key: node_id_test().pub_key().to_string(),
            },
