        ...
        match data {
            CompanyBlockPayload::Update(payload) => {
                ...
                self.country_of_registration = payload
                    ...
                    .apply_to_option(&self.country_of_registration);
                self.city_of_registration = payload
                    .city_of_registration
                    .apply_to_option(&self.city_of_registration);
                self.registration_number = payload
                    .registration_number
                    .apply_to_option(&self.registration_number);
                self.registration_date = payload
                    .registration_date
                    .apply_to_option(&self.registration_date);
                self.logo_file = payload.logo_file.apply_to_option(&self.logo_file);
                self.proof_of_registration_file = payload
                    .proof_of_registration_file
                    .apply_to_option(&self.proof_of_registration_file);
            }
