use crate::{
    ...
    protocol::{Email, Field, OptionalPostalAddress, ProtocolValidationError},
};
...
mod tests {
    use super::*;
    use crate::{
        application::identity::IdentityType, protocol::OptionalPostalAddress,
        protocol::tests::tests::valid_optional_address,
    };
    use rstest::rstest;
    ...
    #[rstest]
    #[case::ident_no_email(IdentityType::Ident, &None, &valid_optional_address(), ValidationError::Protocol(ProtocolValidationError::FieldEmpty(Field::Email)))]
