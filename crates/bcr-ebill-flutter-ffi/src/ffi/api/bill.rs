...
use crate::ffi::{
    ...
    data::{
        ...
        bill::{
            ...
            BillHistoryResponse, BillIdResponse, BillResetMintQuoteState, BillSweepBTCEstimateFfi,
            BillSweepBTCFundsPayload, BillSweepBTCFundsResultFfi, BillsResponse,
            BillsSearchFilterPayload, BitcreditBillFfi, BitcreditBillPayload,
